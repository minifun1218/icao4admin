package org.icao4.eqasbackend2.entity.vocab;
...
/**
 * 航空词汇主题分类实体类
 * 对应数据库表：av_vocab_topics
 * 支持层级结构的主题分类管理
 */
@Entity
@Table(name = "av_vocab_topics", indexes = {
...
public class AvVocabTopic {
    ...
    private List<AvVocabTopic> children;
     ...
     * 检查是否为指定主题的子主题
     */
    public boolean isChildOf(AvVocabTopic parent) {
